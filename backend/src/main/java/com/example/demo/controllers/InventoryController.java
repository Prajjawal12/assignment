...
public class InventoryController {
  ...
  public ResponseEntity<Map<String, Object>> getShelf(@PathVariable Long shelfId) {
  ...
  public ResponseEntity<Map<String, Object>> getShelfPosition(@PathVariable long shelfPositionId) {
  ...
  public ResponseEntity<List<Map<String, Object>>> fetchAllShelfPositionNodes() {
    return ResponseEntity.ok(inventoryServiceImplementation.listAllShelfPositionNodes());
  }
}
