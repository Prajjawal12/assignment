...
public class InventoryServiceTest {
    ...
    void saveShelf_success() {
        ...
        Map<String, Object> actual = inventoryServiceImplementation.saveShelf(shelfV0);
    ...
    void saveShelf_recordNotFound() {
        ...
        assertThrows(RecordNotFoundException.class, () -> inventoryServiceImplementation.saveShelf(shelf));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void saveShelf_exception() {
        ...
        assertThrows(RuntimeException.class, () -> inventoryServiceImplementation.saveShelf(shelf));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void getShelf_success() {
        ...
        Map<String, Object> actual = inventoryServiceImplementation.getShelf(shelfId);
        assertEquals(expected, actual);
        verify(driver).session();
        verify(session).close();
    }
    ...
    void getShelf_recordNotFound() {
        ...
        assertThrows(RecordNotFoundException.class, () -> inventoryServiceImplementation.getShelf(shelfId));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void getShelf_exception() {
        ...
        assertThrows(RuntimeException.class, () -> inventoryServiceImplementation.getShelf(shelfId));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void saveShelfPosition_success() {
        ...
        when(driver.session()).thenReturn(session);
        when(session.executeWrite(any())).thenReturn(expected);
        Map<String, Object> actual = inventoryServiceImplementation.saveShelfPosition(shelfPosition);
        assertEquals(expected, actual);
        verify(driver).session();
        verify(session).close();
    }
    ...
    void saveShelfPosition_exception() {
        ...
        when(driver.session()).thenReturn(session);
        when(session.executeWrite(any())).thenThrow(new RuntimeException("Neo4j Error"));
        assertThrows(RuntimeException.class, () -> inventoryServiceImplementation.saveShelfPosition(shelfPosition));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void getShelfPosition_success() {
        ...
        when(driver.session()).thenReturn(session);
        when(session.executeRead(any())).thenReturn(expected);
        Map<String, Object> actual = inventoryServiceImplementation.getShelfPosition(shelfPositionId);
        assertEquals(expected, actual);
        verify(driver).session();
        verify(session).close();
    }
    ...
    void getShelfPosition_exception() {
        ...
        when(driver.session()).thenReturn(session);
        when(session.executeRead(any())).thenThrow(new RuntimeException("Neo4j Error"));
        assertThrows(RuntimeException.class, () -> inventoryServiceImplementation.getShelfPosition(shelfPositionId));
        verify(driver).session();
        verify(session).close();
    }
    ...
    void addShelfPositionToDevice_exception() {
        ...
        doThrow(new RuntimeException("Neo4j Error")).when(session).executeWriteWithoutResult(any());
